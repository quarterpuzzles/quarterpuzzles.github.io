...
function generateHash(str, algorithm = "SHA-512") {
  ...
  puzzes = ['<h3>Puzzle <sup>2</sup>&frasl;<sub>4</sub></h3><p>New puzzle - function time!</p><p class="math">|x| - 0.802 for |x| &lt 1<br>|<sup>1</sup>&frasl;<sub>2</sub> sin(πx)| + 0.198 for |x| &lt 1</p><p> Answer: <input type="text" id="2" value="answer 2"/></p>',
    '<h3>Puzzle <sup>3</sup>&frasl;<sub>4</sub></h3><p>Hot Springs, Yellowstone, Yosemite, Grand Canyon, Glacier, Olympic, Hawaii volcanoes, Denali, Great Basin, Great Smoky Mountains, Shenandoah, Arches, Great Sand Dunes, Everglades, Theodore Roosevelt, Voyageurs, American Samoa.</p><p> Answer:<input type="text" id="3" value="answer 3"/></p>',
  '<h3>Puzzle <sup>4</sup>&frasl;<sub>4</sub></h3><p>Another puzzle! This time with visual aid!</p><p><img src="image.png"></p><p> Answer: <input type="text" id="4" value="answer 4"/></p>',
  "<h4>YOU WIN!! <3 <br>There is currently no prize, feel free to think of something you'd like ;)</h4>"]
